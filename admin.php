...
<div class="container mt-5">
    <h4 class="text-center mb-4">Admin Panel - User Management</h4><hr>
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserModal1">Add User</button>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editUserModal1"
...
<nav>
    <ul class="pagination justify-content-center">
        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <li class="page-item <?= $i === $page ? 'active' : ''; ?>">
                <a class="page-link text-white bg-dark" href="?search=<?= urlencode($search); ?>&page=<?= $i; ?>"><?= $i; ?></a>
            </li>
        <?php endfor; ?>
    </ul>
</nav>
    ...
    <?php include 'modal_crud_users.php'; ?>
</div>
